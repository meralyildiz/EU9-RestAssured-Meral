...
public class SpartanPojoGetRequestTest extends SpartanTestBase {
    ...
    public void spartanSearchWithPojo() {
        ...
        Spartan s1 = jsonPath.getObject("content[1]", Spartan.class);
    ...
    public void test3(){
        ...
        //here we have already created a class like POM where we have set getter an getter method and toString so we easily use that class to retrieve some infos from database
    }

    @DisplayName("GET  /spartans/search and save as List<Spartan>")
    @Test
    public void test4(){
        //here I would like to save the whole body response, content, as list of spartans
